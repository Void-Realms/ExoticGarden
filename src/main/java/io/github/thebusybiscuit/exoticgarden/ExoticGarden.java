...
public class ExoticGarden extends JavaPlugin implements SlimefunAddon {
    ...
    private void registerItems() {
        ...
        registerPlant("Olives", ChatColor.DARK_GRAY, PlantType.FRUIT, "2b522f734dbb560909eb14f7152c406da5e0d179d7ff1e10f35b69e15670");
    ...
    private void registerMagicalPlant(String name, ItemStack item, String texture, ItemStack[] recipe) {
        ...
        new BonemealableItem(magicalItemGroup, new SlimefunItemStack(enumStyle + "_PLANT", Material.OAK_SAPLING, ChatColor.WHITE + name + " Plant"), RecipeType.ENHANCED_CRAFTING_TABLE, recipe)
            .register(this);
